...
(1, 'Sunglasses', 'Premium sunglasses collection', 1),
(2, 'Wallets', 'Leather and fabric wallets', 1),
(3, 'Scarves', 'Silk and wool scarves', 1),
(4, 'Hats', 'Caps, beanies, and formal hats', 1),
(5, 'Belts', 'Leather and woven belts', 1);
