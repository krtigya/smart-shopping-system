...
<div class="bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
    <div class="px-5 py-4 border-b border-slate-200 flex items-center justify-between">
        ...
        <a href="<?= BASE_URL ?>/admin/product_add.php" class="text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-600 px-4 py-2 rounded-xl">+ Add Product</a>
    </div>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50 align-top">
                    ...
                    <td class="px-5 py-3 text-right whitespace-nowrap">
                        <button type="button" onclick="toggleDetails(<?= $pid ?>)" class="text-indigo-600 hover:text-indigo-800 text-xs font-medium mr-3">Details</button>
                        <a href="<?= BASE_URL ?>/admin/product_edit.php?id=<?= $pid ?>" class="text-sky-600 hover:text-sky-800 text-xs font-medium mr-3">Edit</a>
