...
<div class="flex items-center justify-between mb-5">
    ...
    <a href="<?= BASE_URL ?>/admin/category_add.php" class="text-sm font-semibold text-white bg-pink-500 hover:bg-pink-600 px-4 py-2 rounded-xl">+ Add Category</a>
</div>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50">
                    ...
                    <td class="px-5 py-3 text-right whitespace-nowrap">
                        <a href="<?= BASE_URL ?>/admin/category_add.php?edit=<?= $c['id'] ?>" class="text-pink-600 hover:text-pink-700 text-xs font-medium mr-3">Edit</a>
