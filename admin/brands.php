...
<div class="flex items-center justify-between mb-5">
    ...
    <a href="<?= BASE_URL ?>/admin/brand_add.php" class="text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-600 px-4 py-2 rounded-xl">+ Add Brand</a>
</div>
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50">
                    ...
                    <td class="px-5 py-3 text-right whitespace-nowrap">
                        <a href="<?= BASE_URL ?>/admin/brand_add.php?edit=<?= $b['id'] ?>" class="text-sky-600 hover:text-sky-800 text-xs font-medium mr-3">Edit</a>
