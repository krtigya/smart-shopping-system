...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="overflow-x-auto">
                    ...
                    <tbody class="divide-y divide-indigo-100">
                        ...
                        ?>
                            <tr class="hover:bg-indigo-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-indigo-50 text-indigo-400">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <a href="<?= BASE_URL ?>/orders/order_details.php?id=<?= $order['id'] ?>" class="inline-flex items-center px-4 py-2 bg-indigo-50 hover:bg-indigo-700 text-indigo-600 hover:text-white text-sm font-medium rounded-xl transition-all duration-200 shadow-sm">
            ...
            <?php else: ?>
                <div class="text-center py-16">
                    ...
                    <a href="<?= BASE_URL ?>/index.php" class="inline-flex items-center px-6 py-3 bg-indigo-600 hover:bg-indigo-600 text-white font-medium rounded-xl transition shadow-md hover:shadow-lg">
    ...
    <div class="mt-8 text-center">
        <a href="<?= BASE_URL ?>/index.php" class="inline-flex items-center text-indigo-600 hover:text-indigo-800 font-medium transition">
            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
